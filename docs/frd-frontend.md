...
> 这份文档里的 task 子系统依赖仍保留了早期 project-scoped task API。
> 当前 task create/list 的 canonical contract 已迁移到 orchestration 维度。
> 如涉及 task 工作台，请优先参考 `docs/orchestration-requirements-2026-03-31.md`、`docs/task-api.md`、`docs/frd-task-frontend.md`。
