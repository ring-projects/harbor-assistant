...
import { resolveCodexMcpConfigForWorkspace } from "@/services/codex-config/config.service"
import { getWorkspaceById } from "@/services/workspace/workspace.repository"

type WorkspaceMcpPageProps = {
  params: Promise<{
    workspace_id: string
  }>
}

export default async function WorkspaceMcpPage(props: WorkspaceMcpPageProps) {
  ...
  const mcpResult = await resolveCodexMcpConfigForWorkspace(workspace.path)
